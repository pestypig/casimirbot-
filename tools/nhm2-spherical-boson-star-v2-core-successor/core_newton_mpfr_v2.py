"""Additive MPFR256/equilibrated N=64 frozen-core successor.

This module implements only the preregistered v2 numerical successor.  The
...
def run_frozen_n64_successor() -> FrozenMpfrCoreSuccessorResult:
    """Run exactly one in-memory v2 N=64 diagnostic graph."""
