...
#define TOKEN_SHA256 "33524fdff6e69b40ae75cdff3b3ee1d049a718d70996e08a9397ff18b3e2960a"
#define PRIMARY_ROOT "artifacts/research/nhm2/g2h/tolman-vii-primary-v1"
...
static int primary_execute(const char *contract, const char *source_directory,
    ...
    if (!primary_hash_file("/proc/self/exe", self_hash, &self_bytes)
        || self_bytes == 0
