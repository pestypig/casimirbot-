...
base_archive=${1:?usage: h2_p7_parent_offline_build_guard_r1.sh BASE_ARCHIVE [IMAGE_TAG]}
image_tag=${2:-nhm2-g2h-e-s5-h2-parent-p7:r1}
...
binary=/usr/local/bin/mini-boson-star-primary-c08-h2-parent-p7-r1
required_binary=e6dfc3409a83504143b12cfdf023aa42318d89579d33275fd59643cc69788f56
...
DOCKER_BUILDKIT=0 docker build --pull=false --network=none \
  -f tools/nhm2-spherical-boson-star-v2-branch-proof/g2h/Dockerfile.primary.mini-boson-c08-h2-parent-p7.r1 \
  -t "$image_tag" .
