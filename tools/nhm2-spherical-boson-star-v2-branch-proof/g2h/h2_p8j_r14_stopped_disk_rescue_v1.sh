...
DEV=/dev/disk/by-id/google-nhm2-h2-p8j-r13-evidence-clone
MNT=/mnt/nhm2-p8j-r13-rescue
CAP=/home/pestypig/nhm2-h2-p8j-r13-rescue-capture-v1
OUT=/home/pestypig/nhm2-h2-p8j-r13-stopped-disk-evidence-v1.tgz
...
mkdir "$CAP"
{
  echo SCHEMA=nhm2.h2_p8j_r13.stopped_disk_rescue.v1
  echo DEVICE="$DEV"
...
CTRL="$MNT/home/pestypig/nhm2-h2-p8j-source-v1/tools/nhm2-spherical-boson-star-v2-branch-proof/g2h/h2_p8j_cloud_run_v2.sh"
...
if [[ -d "$MNT/var/log/journal" ]]; then
  journalctl --directory="$MNT/var/log/journal" \
    -u nhm2-h2-p8j-r13.service --no-pager \
...
umount "$MNT"
trap - EXIT
printf 'P8J_R13_RESCUE_READY bytes=%s sha256=%s\n' "$BYTES" "$SHA"
