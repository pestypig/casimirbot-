...
#define TOKEN_SHA256 "39ee95896fbd9d39d13c2762c42cefcf5284a2cb66e78dddadcf0006530dd3c3"
#define PRIMARY_ROOT "artifacts/research/nhm2/g2h/tolman-vii-primary-v3"
#define EXHAUSTED_PRIMARY_ROOT_V1 "artifacts/research/nhm2/g2h/tolman-vii-primary-v1"
#define EXHAUSTED_PRIMARY_ROOT_V2 "artifacts/research/nhm2/g2h/tolman-vii-primary-v2"
    ...
    for (char *line = strtok_r(data, "\n", &save); line != NULL;
        ...
        *equals = '\0';
        ...
        if (strcmp(line, "schema") == 0) {
            bit = 1U << 0;
            accepted = strcmp(value, "nhm2.g2h_execution_authorization.v2") == 0;
...
static int primary_execute(const char *contract, const char *source_directory,
    ...
    if (!primary_is_safe_path(contract) || !primary_is_safe_path(source_directory)
        ...
        || !primary_file_is_absent(EXHAUSTED_PRIMARY_ROOT_V1)
        || !primary_file_is_absent(EXHAUSTED_PRIMARY_ROOT_V2)
