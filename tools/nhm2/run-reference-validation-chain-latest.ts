...
export const buildReferenceValidationChainLatestCommandArgs = (
  ...
  return [
    ...
    ...forwardStringArg("qei-bound-receipt"),
    ...forwardStringArg("qei-bound-model-kind"),
    ...forwardStringArg("qei-bound-si"),
    ...forwardStringArg("qei-bound-provenance-ref"),
    ...forwardStringArg("qei-tau-seconds"),
    ...forwardStringArg("qei-tau-source-ref"),
    ...forwardStringArg("qei-duty-cycle"),
    ...forwardStringArg("qei-duty-cycle-source-ref"),
    ...forwardStringArg("qei-light-crossing-seconds"),
    ...forwardStringArg("qei-light-crossing-source-ref"),
    ...forwardStringArg("qei-modulation-seconds"),
    ...forwardStringArg("qei-modulation-source-ref"),
    ...forwardStringArg("qei-sampling-kind"),
    ...forwardBooleanArg("qei-sampling-normalized"),
    ...forwardStringArg("qei-qft-state-ref"),
    ...forwardStringArg("qei-renormalization-ref"),
    ...forwardStringArg("qei-renormalization-convention-ref"),
    ...forwardBooleanArg("qei-stationary-worldline-assumption"),
