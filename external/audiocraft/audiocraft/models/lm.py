...
class LMModel(StreamingModule):
    ...
    def forward(self, sequence: torch.Tensor,
        ...
        # Optional spectral adapters: attach an nn.Module (e.g., nn.Sequential of SpectralBlock)
        if hasattr(self, "spectral_adapters") and self.spectral_adapters is not None:
            input_ = self.spectral_adapters(input_)
