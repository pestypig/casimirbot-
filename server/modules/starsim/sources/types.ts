...
export const STAR_SIM_SOURCE_SELECTION_SCHEMA_VERSION = "star-sim-source-selection/2" as const;
export const STAR_SIM_SOURCE_CACHE_SCHEMA_VERSION = "star-sim-source-cache/1" as const;
export const STAR_SIM_SOURCE_REGISTRY_VERSION = "star-sim-sources/5" as const;
