...
export const theoryIdeologyBridgeSpec: ToolSpecShape = {
  ...
  desc: "Deterministic evidence-only bridge between Theory graph reflection and ZenGraph reflection. Produces procedural links, missing evidence, and overclaim guards; never final authority.",
  inputSchema: {
    type: "object",
    properties: {
      prompt: { type: "string" },
