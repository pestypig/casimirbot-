...
describe("Helix Ask turn-contract planner-metadata extraction boundary", () => {
  it("keeps planner metadata packaging out of agi.plan.ts", () => {
    ...
    expect(routeSource).toContain("../services/helix-ask/contracts/turn-contract-planner-metadata");
    expect(routeSource).toContain("planner: buildHelixAskTurnContractPlannerMetadata({");
