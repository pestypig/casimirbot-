...
export type HelixAgentRunRequest = {
  ...
  /**
   * Trusted server-composition input containing gateway observations that were
   * already executed and admitted before this provider resume. It is never
   * populated from the public request body or model-authored arguments.
   */
  reenteredWorkstationGatewayCallResults?: HelixWorkstationGatewayCallResult[];
  /**
