...
export const buildHelixCapabilityLaneGoalDispatchAdmission = (
  ...
  return {
    ...
    selected_runtime_agent_provider: dispatchPlan.selected_runtime_agent_provider,
    requested_backend_provider: dispatchPlan.requested_backend_provider ?? null,
    selected_backend_provider: dispatchPlan.selected_backend_provider ?? null,
    fallback_backend_provider: dispatchPlan.fallback_backend_provider ?? null,
    backend_selection_reason: dispatchPlan.backend_selection_reason ?? null,
    cost_class: dispatchPlan.cost_class ?? null,
    latency_class: dispatchPlan.latency_class ?? null,
    privacy_class: dispatchPlan.privacy_class ?? null,
    session_control_key: dispatchPlan.session_control_key ?? null,
    source_binding_key: dispatchPlan.source_binding_key ?? null,
    source_identity_key: dispatchPlan.source_identity_key ?? null,
