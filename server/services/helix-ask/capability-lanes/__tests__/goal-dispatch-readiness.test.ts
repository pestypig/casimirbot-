...
const buildPlan = (
  ...
  latest_mail_loop_observation_key:
    `docs:${goalBindingId}::sha256:${goalBindingId}::docs_chunk::es::chunk:${goalBindingId}::${receiptRef ?? `ask:lane:translation:${goalBindingId}:obs`}`,
  ...
  it("aggregates next evidence and receipt refs from admitted dispatch admissions without granting side effects", () => {
    ...
    expect(buildHelixCapabilityLaneGoalDispatchReadiness({
      ...
      next_mail_loop_observation_keys: [
        "docs:goal-binding-ready::sha256:goal-binding-ready::docs_chunk::es::chunk:goal-binding-ready::ask:lane:translation:ready-obs:projection:receipt",
        "docs:goal-binding-ready-duplicate::sha256:goal-binding-ready-duplicate::docs_chunk::es::chunk:goal-binding-ready-duplicate::ask:lane:translation:ready-obs:projection:receipt",
      ],
