...
export const TOOL_FAMILY_CONTRACTS: ToolFamilyContract[] = [
  ...
  contract({
    toolName: "live_env.query_trace_memory",
    toolFamily: "live_source_mail",
    authority: "evidence_only",
    mutating: false,
    requiredObservationKinds: [
  ...
  contract({
    ...
    requiredReentry: true,
    requiresGoalSatisfaction: true,
    aliases: ["repair_workstation_source", "repair_source", "repair_loop", "source_repair"],
  }),
  contract({
