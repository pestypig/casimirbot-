...
export const TOOL_FAMILY_DEFAULT_CONTRACTS: Record<ToolFamily, ToolFamilyContract> = {
  calculator: contract({
    ...
    mutating: false,
    requiredObservationKinds: ["calculator_receipt", "calculation_trace", "calculator_validation"],
  ...
  docs_viewer: contract({
    ...
    authority: "evidence_only",
    mutating: false,
    requiredObservationKinds: ["doc_location_result", "doc_location_matches", "docs_viewer_receipt"],
