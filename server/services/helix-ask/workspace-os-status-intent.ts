...
export const workspaceOsStatusReasonCodes = (promptText: string | null | undefined): string[] => {
  ...
  if (/\bworkspace\s+(?:status|capabilit(?:y|ies)|surfaces?)\b/i.test(prompt)) reasons.add("workspace_status_phrase");
