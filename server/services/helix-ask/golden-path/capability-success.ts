...
export const buildGoldenPathCapabilitySuccessPayload = (args: {
  ...
  return {
    ...
    current_turn_artifact_ledger: buildGoldenPathCapabilitySuccessLedgerArtifacts({
      turnId: args.turnId,
      createdAtMs: args.createdAtMs,
      goalHash,
      routeGateArtifactId: args.routeGateArtifactId,
      routeGateTerminalEligible: args.routeGateTerminalEligible,
      ...(args.includeRouteGatePromptText === false ? {} : { routeGatePromptText: args.promptText }),
      requestedCapability: args.requestedCapability,
      goalSatisfactionArtifact,
      ...
      observedArtifactKind: args.observedArtifactKind,
      observationProducerItemId: args.observationProducerItemId,
      observationPayload: args.observationPayload,
      terminalArtifactId: args.terminalArtifactId,
      terminalArtifactKind: args.requiredTerminalKind,
      terminalProducerItemId: args.answerProducerItemId,
      terminalPayloadSchema: args.terminalPayloadSchema,
      terminalResult,
      terminalExtraPayload: args.answerLedgerExtraPayload,
    }),
