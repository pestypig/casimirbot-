...
export type HelixAskGoldenPathRuntimeTerminalResult = {
  ...
  result_id: string;
  artifact_id: string;
  artifact_kind: "golden_path_contract_answer" | "compound_evidence_synthesis_answer";
  final_answer_source: "helix_ask_golden_path_runtime" | "compound_evidence_synthesis_answer";
  text: string;
  support_refs: string[];
