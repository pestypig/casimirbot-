...
const WORKSTATION_OBSERVATION_TERMINAL_KINDS = new Set([
  ...
  "stage_play_live_source_mail_wake_result_projection",
  ...
  "stage_play_mailbox_wake_result",
  ...
  "stage_play_micro_reasoner_run.v1",
  ...
  "stage_play_workstation_actuator_ref",
  "stage_play_workstation_actuator_refs",
  "trace_memory",
  ...
  "wake_result",
  "wake_results",
  "workstation_actuator",
  "workstation_actuator_ref",
  "workstation_actuator_refs",
]);
