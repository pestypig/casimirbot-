...
export function normalizeEnvironmentStateSnapshot(input: {
  ...
  const snapshot: HelixEnvironmentStateSnapshot = {
    ...
    route_state: routeState ? {
      ...
      latest_lifecycle_receipt_id: cleanString(routeState.latest_lifecycle_receipt_id) ?? null,
      route_lifecycle_status: cleanString(routeState.route_lifecycle_status) ?? null,
      route_intent_status: cleanString(routeState.route_intent_status) ?? null,
