...
const tools: HelixLiveCognitionTool[] = [
  tool({
    tool_id: "live-cognition.synthesize_line_from_observations",
    family: "review",
    label: "Synthesize line from observations",
    input_requirements: ["observation_refs", "interpretation_refs", "line_key"],
  ...
  tool({
    tool_id: "observation_journal.latest",
    family: "review",
    label: "Read latest observations",
    input_requirements: ["thread_id", "source_scope"],
  ...
  tool({
    tool_id: "interpretation_card.missing_evidence",
    family: "review",
    label: "Read interpretation gaps",
    input_requirements: ["interpretation_refs"],
  ...
  tool({
    tool_id: "visual.latest_observation",
    family: "visual",
    label: "Read latest visual observation",
    input_requirements: ["visual_observation_refs"],
    output_evidence_kind: "visual_frame_evidence",
    allowed_line_keys: ["scene", "activity", "objects", "place", "structure", "entities", "evidence"],
    can_run_automatically: true,
    requires_user_confirmation: false,
  }),
  tool({
    tool_id: "visual.compare_recent_frames",
    family: "visual",
    label: "Compare recent visual frames",
    input_requirements: ["recent_visual_observation_refs"],
    output_evidence_kind: "review",
    allowed_line_keys: ["scene", "activity", "objects", "evidence", "uncertainty", "next_check", "last_update"],
    can_run_automatically: true,
    requires_user_confirmation: false,
  }),
  tool({
