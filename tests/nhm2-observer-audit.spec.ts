    ...
    const artifact = buildNhm2ObserverAuditArtifact({
      ...
      observerDecPhysicsControlEvidence: {
        ...
        refinementEvidence: {
          ...
          coarseStepM: 0.1,
          refinedStepM: 0.05,
          superRefinedStepM: 0.025,
          observedConvergenceOrderT0i: 1.9,
          observedConvergenceOrderOffDiagonal: 2.1,
          richardsonExtrapolatedResidualT0i: 0.011,
          richardsonExtrapolatedResidualOffDiagonal: 0.012,
          richardsonExtrapolatedMetricDecMarginToZero: -0.16192,
          richardsonExtrapolatedTileReconstitutedDecMarginToZero: -0.16192,
          uncertaintyRelativeBound: 0.02,
          uncertaintyAbsMetricDec: 0.0032,
          uncertaintyAbsTileReconstitutedDec: 0.0032,
          conservativeMetricDecMarginToZero: -0.1632,
          conservativeTileReconstitutedDecMarginToZero: -0.1632,
          uncertaintyBoundPass: false,
          note: "refinement-aware uncertainty localization fixture",
          citationRefs: [
