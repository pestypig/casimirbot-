...
| Voice continuation and intent-shift policy | `shouldMergeVoiceContinuationInFlight`, `shouldRestartExplorationLadderOnSupersede`, `isLikelyContinuationAddendum`, `isLikelyContinuationTailFragment`, `scoreIntentShift` | Latest-turn continuation semantics, supersede/restart policy, and voice intent arbitration; deterministic lexical predicates live in `ask-voice-continuation-lexical.ts`, while in-flight merge and restart policy remain behavior-sensitive. |
