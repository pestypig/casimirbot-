...
export function LumaWhisper({
  ...
  return (
    <div
      className={`fixed bottom-5 right-5 z-40 flex items-center gap-3 px-3 py-2 rounded-2xl border bg-slate-950/85 border-slate-700 backdrop-blur shadow-lg transition-opacity duration-300 ${
