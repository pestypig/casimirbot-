  ...
  return (
    <aside className="flex w-64 shrink-0 flex-col border-r border-zinc-950 bg-zinc-950/95 text-zinc-100">
      <div className="border-b border-zinc-800 px-3 py-2">
        <div className="text-xs font-bold uppercase tracking-wide text-cyan-200">QEI</div>
        <div className="text-sm font-semibold">Stress-Energy</div>
      </div>
      ...
      <div className="border-t border-zinc-800 p-2">
        {selectedGroup ? (
          ...
          <div className="text-[11px] text-zinc-500">Pick a QEI/stress group to light diagnostic badges.</div>
        )}
      </div>
    </aside>
  );
