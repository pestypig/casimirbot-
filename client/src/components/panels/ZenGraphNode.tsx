...
export type ZenGraphNodeProps = {
  title: string;
  subtitle?: string;
  tone?: "lens" | "root" | "safeguard" | "missing" | "neutral";
};

const toneClass: Record<NonNullable<ZenGraphNodeProps["tone"]>, string> = {
...
export function ZenGraphNode({ title, subtitle, tone = "neutral" }: ZenGraphNodeProps) {
  return (
