...
export const HELIX_SITUATION_GRAPH_RECIPES: HelixSituationGraphRecipe[] = [
  ...
  recipe({
    ...
    title: "Standby voice chat monitor",
    aliases: ["stand by and watch this voice chat", "watch this discord session", "tell me when something important happens"],
    description: "Watches granted voice-chat sources and emits typed salience proposals only when useful.",
    required_bindings: ["room_id", "source_ids", "standby_mode"],
    optional_bindings: ["interjection_policy"],
    nodes: [
      { local_id: "source", capability_id: "source.browser_tab_audio", title: "Voice chat source" },
      { local_id: "timeline", capability_id: "monitor.timeline_join", title: "Timeline join" },
      { local_id: "projection", capability_id: "monitor.world_state_projection", title: "State projection" },
      { local_id: "goal", capability_id: "monitor.goal_hypothesis", title: "Goal hypothesis" },
      { local_id: "salience", capability_id: "monitor.salience_gate", title: "Salience gate", params: { mode: "high_salience" } },
      { local_id: "proposal", capability_id: "monitor.interjection_proposal", title: "Interjection proposal" },
      { local_id: "helix", capability_id: "helix.attach_context", title: "Attach to Helix" },
    ],
    edges: [
      { from: "source", from_port: "audio", to: "timeline", to_port: "signal" },
      { from: "timeline", from_port: "timeline", to: "projection", to_port: "timeline" },
      { from: "projection", from_port: "projection", to: "goal", to_port: "projection" },
      { from: "goal", from_port: "goal", to: "salience", to_port: "signal" },
      { from: "salience", from_port: "receipt", to: "proposal", to_port: "receipt" },
      { from: "proposal", from_port: "context", to: "helix", to_port: "context" },
    ],
  }),
  recipe({
    recipe_id: "standby_translation_mediator",
    title: "Standby translation mediator",
    aliases: ["standby translation mediator", "watch translation mediation", "mediate this conversation"],
    description: "Observes translation mediation health and proposes interventions without auto-speaking.",
    required_bindings: ["room_id", "source_ids", "speaker_a_id", "speaker_b_id", "speaker_a_native_language", "speaker_b_native_language"],
    optional_bindings: ["standby_mode", "output_mode"],
    nodes: [
      { local_id: "source", capability_id: "source.browser_tab_audio", title: "Conversation source" },
      { local_id: "split", capability_id: "identity.speaker_split", title: "Speaker split" },
      { local_id: "translation_health", capability_id: "monitor.translation_health", title: "Translation health" },
      { local_id: "salience", capability_id: "monitor.salience_gate", title: "Mediation gate", params: { mode: "translation_mediator" } },
      { local_id: "proposal", capability_id: "monitor.interjection_proposal", title: "Mediation proposal" },
      { local_id: "helix", capability_id: "helix.attach_context", title: "Attach to Helix" },
    ],
    edges: [
      { from: "source", from_port: "audio", to: "split", to_port: "audio" },
      { from: "split", from_port: "speakers", to: "translation_health", to_port: "translation" },
      { from: "translation_health", from_port: "signal", to: "salience", to_port: "signal" },
      { from: "salience", from_port: "receipt", to: "proposal", to_port: "receipt" },
      { from: "proposal", from_port: "context", to: "helix", to_port: "context" },
    ],
  }),
  recipe({
    ...
    aliases: ["stand by and watch minecraft", "minecraft world monitor", "watch this minecraft session"],
    description: "Joins Minecraft world/plugin events with granted audio/screen signals and emits salience receipts.",
    required_bindings: ["room_id", "source_ids", "standby_mode"],
    optional_bindings: ["world_id", "interjection_policy"],
    nodes: [
      { local_id: "world", capability_id: "source.minecraft_events", title: "Minecraft events" },
      { local_id: "audio", capability_id: "source.browser_tab_audio", title: "Minecraft audio" },
      { local_id: "screen", capability_id: "source.screen_summary", title: "Screen summary" },
      { local_id: "split", capability_id: "identity.speaker_split", title: "Speaker split" },
      { local_id: "timeline", capability_id: "monitor.timeline_join", title: "Timeline join" },
      { local_id: "projection", capability_id: "monitor.world_state_projection", title: "World projection" },
      { local_id: "goal", capability_id: "monitor.goal_hypothesis", title: "Goal hypothesis" },
      { local_id: "salience", capability_id: "monitor.salience_gate", title: "Danger gate", params: { mode: "game_master" } },
      { local_id: "proposal", capability_id: "monitor.interjection_proposal", title: "Interjection proposal" },
      { local_id: "helix", capability_id: "helix.attach_context", title: "Attach to Helix" },
    ],
    edges: [
      { from: "world", from_port: "event", to: "timeline", to_port: "signal" },
      { from: "audio", from_port: "audio", to: "split", to_port: "audio" },
      { from: "screen", from_port: "summary", to: "timeline", to_port: "text" },
      { from: "split", from_port: "speakers", to: "timeline", to_port: "signal" },
      { from: "timeline", from_port: "timeline", to: "projection", to_port: "timeline" },
      { from: "projection", from_port: "projection", to: "goal", to_port: "projection" },
      { from: "goal", from_port: "goal", to: "salience", to_port: "signal" },
      { from: "salience", from_port: "receipt", to: "proposal", to_port: "receipt" },
  ...
  recipe({
    recipe_id: "minecraft_goal_watch",
    title: "Minecraft goal watch",
    aliases: ["watch minecraft goal", "track this minecraft objective", "minecraft goal watch"],
    description: "Tracks Minecraft objective cues and produces goal-progress salience receipts.",
    required_bindings: ["room_id", "source_ids", "standby_mode"],
    optional_bindings: ["goal_label", "world_id"],
    nodes: [
      { local_id: "world", capability_id: "source.minecraft_events", title: "Minecraft events" },
      { local_id: "timeline", capability_id: "monitor.timeline_join", title: "Timeline join" },
      { local_id: "goal", capability_id: "monitor.goal_hypothesis", title: "Goal hypothesis" },
      { local_id: "salience", capability_id: "monitor.salience_gate", title: "Goal salience" },
      { local_id: "proposal", capability_id: "monitor.interjection_proposal", title: "Goal proposal" },
    ],
    edges: [
      { from: "world", from_port: "event", to: "timeline", to_port: "signal" },
      { from: "timeline", from_port: "timeline", to: "goal", to_port: "projection" },
      { from: "goal", from_port: "goal", to: "salience", to_port: "signal" },
      { from: "salience", from_port: "receipt", to: "proposal", to_port: "receipt" },
    ],
  }),
  recipe({
    recipe_id: "screen_share_research_watch",
    title: "Screen-share research watch",
    aliases: ["watch this research screen", "screen share research watch", "monitor this screen share"],
    description: "Watches explicit screen summaries for research state changes without injecting raw screen context.",
    required_bindings: ["room_id", "source_ids", "standby_mode"],
    optional_bindings: ["research_goal"],
    nodes: [
      { local_id: "screen", capability_id: "source.screen_summary", title: "Screen summary" },
      { local_id: "timeline", capability_id: "monitor.timeline_join", title: "Timeline join" },
      { local_id: "projection", capability_id: "monitor.world_state_projection", title: "Research state" },
      { local_id: "salience", capability_id: "monitor.salience_gate", title: "Research salience", params: { mode: "research_assistant" } },
      { local_id: "proposal", capability_id: "monitor.interjection_proposal", title: "Research proposal" },
      { local_id: "helix", capability_id: "helix.attach_context", title: "Attach to Helix" },
    ],
    edges: [
      { from: "screen", from_port: "summary", to: "timeline", to_port: "text" },
      { from: "timeline", from_port: "timeline", to: "projection", to_port: "timeline" },
      { from: "projection", from_port: "projection", to: "salience", to_port: "signal" },
      { from: "salience", from_port: "receipt", to: "proposal", to_port: "receipt" },
      { from: "proposal", from_port: "context", to: "helix", to_port: "context" },
    ],
  }),
