  ...
  it("locates canonical philosophy-derived badges and alias-only cues", async () => {
    ...
    const locator = locateMoralBadges(canonicalGraph, {
      ...
      text: [
        ...
        "Use dependency-transparency-gate for hidden shared risk and late disclosure.",
        "Use agency-preserving-disclosure when withheld information means someone could not plan.",
        "Use shame-avoidance-loop for hiding because of shame and delaying conflict.",
        "Use fallout-transfer-check for externalized fallout and shifted burden.",
        "Balance rural and urban density with familiarity-anonymity-balance and repeated contact.",
        "Use trust-medium-translation when relational trust becomes a formal record.",
        "Keep credit history inside domain-bounded-accountability instead of moral worth.",
        "Require contestable-reentry-threshold for excluded people, appeal paths, and fresh starts.",
