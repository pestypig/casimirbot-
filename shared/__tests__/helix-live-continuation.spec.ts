...
const callout: HelixCalloutCandidate = {
  ...
  room_id: "room:test",
  environment_id: "env:test",
  source_tick_id: "tick:test",
  priority: "warn",
  certainty: "medium",
  callout_intent: "warning",
  summary: "Potential cave-entry risk; confirmation still requires fresh visual evidence.",
  claim_refs: ["worker:test"],
  missing_evidence: ["latest visual frame"],
  delivery_mode: "voice_proposal",
