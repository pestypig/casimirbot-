...
// The outer observation lease is distinct from the connector's execution
// ceiling. Packaged local durability may synchronously seal several ordered
// workflow events before the terminal result, so preserve enough delivery
// runway without granting the resident executor any additional action ticks.
export const HELIX_ENVIRONMENT_ACTION_RESULT_DELIVERY_GRACE_MS = 15_000;
