...
export const HELIX_GRAPH_CAPABILITIES: HelixGraphCapability[] = [
  ...
  capability({
    capability_id: "transform.sentence_summary",
    title: "Live sentence summary",
    description: "Creates compact deterministic sentence/window summaries from live source events.",
    family: "transform",
    input_ports: [{ port_id: "source_event", kind: "monitor_signal", required: true }],
    output_ports: [{ port_id: "summary", kind: "text" }],
    parameter_schema: { type: "object", properties: { max_chars: { type: "number" } } },
    risk: "low",
    requires_confirmation: false,
    execution_mode: "on_event",
  }),
  capability({
    capability_id: "transform.philosophy_compare",
    title: "Philosophy comparator",
    description: "Compares compact live source windows against a named philosophy framework.",
    family: "transform",
    input_ports: [{ port_id: "summary", kind: "text", required: true }],
    output_ports: [{ port_id: "comparison", kind: "text" }],
    parameter_schema: { type: "object", properties: { framework: { type: "string" } } },
    risk: "medium",
    requires_confirmation: false,
    execution_mode: "manual",
  }),
  capability({
    capability_id: "transform.methods_note_writer",
    title: "Methods note writer",
    description: "Writes compact methods-note chunks from live computation windows.",
    family: "transform",
    input_ports: [{ port_id: "source_event", kind: "monitor_signal", required: true }],
    output_ports: [{ port_id: "note_chunk", kind: "text" }],
    parameter_schema: { type: "object", properties: { cadence: { type: "string" } } },
    risk: "low",
    requires_confirmation: false,
    execution_mode: "on_event",
  ...
  capability({
    capability_id: "output.live_answer_environment",
    title: "Live answer environment sink",
    description: "Writes transform output into compact live answer environment lines.",
    family: "output",
    input_ports: [{ port_id: "line_update", kind: "text", required: true }],
    output_ports: [{ port_id: "receipt", kind: "receipt" }],
    parameter_schema: { type: "object", properties: { environment_id: { type: "string" } } },
    risk: "low",
    requires_confirmation: false,
    execution_mode: "on_event",
  }),
  capability({
    capability_id: "output.live_note_sink",
    title: "Live note sink",
    description: "Appends transformed live source chunks to Workstation Notes with evidence references.",
    family: "output",
    input_ports: [{ port_id: "note_chunk", kind: "text", required: true }],
    output_ports: [{ port_id: "receipt", kind: "receipt" }],
    parameter_schema: { type: "object", properties: { note_id: { type: "string" } } },
    risk: "low",
    requires_confirmation: false,
    execution_mode: "on_event",
  }),
