...
describe("deterministic ZenGraph ideology reflection", () => {
  ...
  it("detects nearby safeguards and action gate warnings", () => {
    ...
    expect(reflection.recommended_actions.map((action) => action.id)).toContain("zen-graph.show_nearby_safeguard");
  });
