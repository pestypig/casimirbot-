...
import { validateZenBadgeLocatorV1 } from "../../zen-badge-locator";
...
describe("Zen badge locator", () => {
  it("produces a valid zen_badge_locator/v1 artifact with evidence-only authority", () => {
