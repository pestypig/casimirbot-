...
import { ZEN_WISDOM_PRINCIPLES, ZEN_WISDOM_ROOT_ID } from "./wisdom-principles";
...
function wisdomPrincipleTerms(rootId: string, refs: string[]): FruitionProcedureTermV1[] {
  ...
  return ZEN_WISDOM_PRINCIPLES.map((principle) => ({
...
function buildOperators(params: {
  ...
  operators.push({
    ...
    rationale: "ZenGraph and Fruition artifacts are diagnostic evidence and cannot unlock terminal execution.",
  });
