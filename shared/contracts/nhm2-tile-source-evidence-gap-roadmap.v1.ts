    ...
    decisiveMeasurements: [
      {
        ...
        quantity: "active-control waveform, calibration, transfer, thermal, timing, and lock traces",
        target: "14 active-control trace refs",
        unit: "ref count",
        ...
        goCriterion: "all required active-control waveform, calibration, thermal, timing, and lock traces are present",
