...
> = {
  material_coupon: {
    ...
    measurements: ["thin_film_stress_curve", "yield_or_fracture_margin", "cryogenic_material_state"],
  },
  force_gap_pull_in: {
  ...
  active_control_energy: {
    ...
    measurements: ["active_control_energy_per_cycle", "control_noise_spectrum", "gap_lock_bandwidth"],
  },
  fatigue_lifetime: {
    ...
    measurements: ["cycle_count_to_failure", "creep_or_drift_rate", "thermal_cycle_margin"],
  },
  layer_scaling: {
    ...
    measurements: ["multi_layer_force_scaling", "nonadditivity_bound", "cross_layer_coupling"],
  },
  full_apparatus_tensor: {
