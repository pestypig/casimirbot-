...
const REQUIRED_TARGET_KEY_BY_CORRECTION_KEY: Record<string, string> = {
  ...
  authorityMetadataMissingCount: "requiredAuthorityMetadataCount",
  ...
  conductivityReceiptComplete: "conductivityRefRequired",
  conductivityNumericValueAvailable: "conductivityRefRequired",
  ...
  dielectricResponseReceiptComplete: "dielectricResponseRefRequired",
  dielectricResponseNumericValueAvailable: "dielectricResponseRefRequired",
  ...
  tensorValueArtifactAvailable: "tensorValueArtifactRequired",
