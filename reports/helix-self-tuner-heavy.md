...
- run_id: versatility-1771567838142
...
- run_duration_ms: 244177
- terminated_early_reason: none
- global_cooldown_applied_ms: 0
- resumed_from_latest: false
- resumed_runs: 0
- output_run_dir: /workspace/casimirbot-/artifacts/experiments/helix-self-tuner/heavy/versatility-1771567838142

## Aggregate by Prompt Family
| family | runs | pass_rate | intent_correct_rate | report_mode_correct_rate | stub_rate | latency_p50_ms | latency_p95_ms |
|---|---:|---:|---:|---:|---:|---:|---:|
| relation | 90 | 96.7% | 96.7% | 100.0% | 0.0% | 481 | 1346 |
| repo_technical | 90 | 100.0% | 0.0% | 100.0% | 0.0% | 924 | 2053 |
| ambiguous_general | 90 | 96.7% | 0.0% | 96.7% | 0.0% | 844 | 1641 |
...
- latency_total_p50_ms: 762
- latency_total_p95_ms: 1968
- latency_retrieval_p50_ms: 207 (samples=262)
- latency_retrieval_p95_ms: 412 (samples=262)
...
### Worst #3: ambiguous_28_how-can-i-identify-high-impact-failure-categories
- family: ambiguous_general
...
### Worst #7: repo_tech_29_what-checks-enforce-presence-of-citations-in-repo-hybrid-responses
- family: repo_technical
...
### Worst #8: ambiguous_20_how-do-i-triage-failures-quickly
- family: ambiguous_general
