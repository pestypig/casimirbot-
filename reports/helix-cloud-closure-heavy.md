...
- run_id: versatility-1771617912746
...
- run_duration_ms: 260055
- terminated_early_reason: none
- global_cooldown_applied_ms: 0
- resumed_from_latest: false
- resumed_runs: 0
- output_run_dir: /workspace/casimirbot-/artifacts/experiments/helix-cloud-closure/heavy/versatility-1771617912746

## Aggregate by Prompt Family
| family | runs | pass_rate | intent_correct_rate | report_mode_correct_rate | stub_rate | latency_p50_ms | latency_p95_ms |
|---|---:|---:|---:|---:|---:|---:|---:|
| relation | 90 | 96.7% | 96.7% | 100.0% | 0.0% | 505 | 1406 |
| repo_technical | 90 | 100.0% | 0.0% | 100.0% | 0.0% | 958 | 2226 |
| ambiguous_general | 90 | 96.7% | 0.0% | 96.7% | 0.0% | 925 | 1680 |
...
- latency_total_p50_ms: 830
- latency_total_p95_ms: 2031
- latency_retrieval_p50_ms: 227 (samples=256)
- latency_retrieval_p95_ms: 429 (samples=256)
...
### Worst #3: repo_tech_25_how-does-report-mode-reason-get-set-and-propagated-to-debug
- family: repo_technical
- question: How does report_mode_reason get set and propagated to debug?
- failures: none
...
- final_answer:
```text
Interpretation: "mode quantization" is treated as boundary-conditions-modes. [docs/knowledge/physics/boundary-conditions-modes.md] 1. Interpretation: "mode quantization" is treated as boundary-conditions-modes. [docs/knowledge/physics/boundary-conditions-modes.md] 2. What boundary assumptions are used, and which geometry is being modeled? [docs/knowledge/physics/boundary-conditions-modes.md] 3. Boundary conditions restrict the allowed field modes, which changes the energy spectrum and drives Casimir forces. [docs/knowledge/physics/boundary-conditions-modes.md] 4. Geometry-specific assumptions live alongside the static Casimir calculations. [docs/knowledge/physics/boundary-conditions-modes.md] In practice, What boundary assumptions are used, and which geometry is being modeled? [docs/knowledge/physics/boundary-conditions-modes.md] Sources: docs/knowledge/physics/boundary-conditions-modes.md, client/src/components/electronorbitalpanel.ts, client/src/hooks/useelectronorbitsim.ts, docs/stellar-consciousness-orch-or-review.md, docs/knowledge/trees/stellar-restoration-tree.md, docs/stellar-consciousness-ii.md, docs/papers.md, docs/knowledge/stellar-restoration-tree.json
```
...
### Worst #15: relation_25_from-docs-perspective-how-do-warp-bubble-files-and-ethos-files-relate
- family: relation
