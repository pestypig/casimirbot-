...
- run_id: versatility-1771685591979
...
- run_duration_ms: 89278
- terminated_early_reason: none
- global_cooldown_applied_ms: 0
- resumed_from_latest: false
- resumed_runs: 0
- output_run_dir: C:\Users\dan\Desktop\RESEARCH 1,0\research\Alcubierre drive\casimirbot.com\versions\CasimirBot (9-3-25)\CasimirBot (9-3-25)\CasimirBot\artifacts\experiments\helix-novelty-patch-localcheck\narrow\versatility-1771685591979

## Aggregate by Prompt Family
| family | runs | pass_rate | intent_correct_rate | report_mode_correct_rate | stub_rate | latency_p50_ms | latency_p95_ms |
|---|---:|---:|---:|---:|---:|---:|---:|
| relation | 45 | 100.0% | 100.0% | 100.0% | 0.0% | 404 | 879 |
| repo_technical | 45 | 100.0% | 0.0% | 100.0% | 0.0% | 520 | 1246 |
| ambiguous_general | 45 | 100.0% | 0.0% | 100.0% | 0.0% | 623 | 1214 |
...
- latency_total_p50_ms: 542
- latency_total_p95_ms: 1214
- latency_retrieval_p50_ms: 128 (samples=131)
- latency_retrieval_p95_ms: 215 (samples=131)
- latency_synthesis_p50_ms: 1 (samples=135)
- latency_synthesis_p95_ms: 19 (samples=135)
...
### Worst #3: ambiguous_30_what-s-the-difference-between-routing-and-assembly
- family: ambiguous_general
...
- final_answer:
```text
Evidence is limited in current retrieval; claims are bounded to available artifacts and may be incomplete. [docs/knowledge/trees/panel-concepts-tree.md] In practice, coupled constraints and feedback loops determine how outcomes evolve over time. [docs/knowledge/trees/panel-concepts-tree.md] Sources: docs/knowledge/trees/panel-concepts-tree.md, client/src/components/common/lrldocstooltip.ts, server/instruments/pump-multitone.ts, shared/tokenizers/bpe.ts, modules/core/module-registry.ts, server/services/debate/orchestrator.ts, server/qi/qi-monitor.ts, client/src/lib/qi/qi-auto-tuner.ts

Missing evidence: add directly relevant repo paths or artifact refs to raise confidence.
```

### Worst #6: repo_tech_27_where-are-claim-coverage-metrics-computed-and-used-as-gates
- family: repo_technical
...
### Worst #8: repo_tech_13_how-does-goal-zone-harness-evaluate-pass-fail-across-seeds
- family: repo_technical
...
### Worst #9: ambiguous_28_how-can-i-identify-high-impact-failure-categories
- family: ambiguous_general
...
### Worst #10: relation_27_how-does-relation-mode-answer-tie-warp-bubble-to-ideology-without-report
- family: relation
