...
- run_id: versatility-1771617772919
...
- run_duration_ms: 134321
- terminated_early_reason: none
- global_cooldown_applied_ms: 0
- resumed_from_latest: false
- resumed_runs: 0
- output_run_dir: /workspace/casimirbot-/artifacts/experiments/helix-cloud-closure/narrow/versatility-1771617772919

## Aggregate by Prompt Family
| family | runs | pass_rate | intent_correct_rate | report_mode_correct_rate | stub_rate | latency_p50_ms | latency_p95_ms |
|---|---:|---:|---:|---:|---:|---:|---:|
| relation | 45 | 100.0% | 100.0% | 100.0% | 0.0% | 584 | 1382 |
| repo_technical | 45 | 100.0% | 0.0% | 100.0% | 0.0% | 797 | 2101 |
| ambiguous_general | 45 | 100.0% | 0.0% | 100.0% | 0.0% | 937 | 1977 |
...
- latency_total_p50_ms: 878
- latency_total_p95_ms: 1977
- latency_retrieval_p50_ms: 252 (samples=131)
- latency_retrieval_p95_ms: 455 (samples=131)
...
### Worst #8: repo_tech_08_what-does-api-agi-adapter-run-return-for-pass-fail-and-certificate-data
- family: repo_technical
...
### Worst #12: ambiguous_25_when-is-deterministic-fallback-preferable
- family: ambiguous_general
...
### Worst #14: repo_tech_17_explain-retrieval-confidence-and-deterministic-contract-signal-threshold
- family: repo_technical
