...
- run_id: versatility-1771699737631
...
- run_duration_ms: 106152
- terminated_early_reason: none
- global_cooldown_applied_ms: 0
- resumed_from_latest: false
- resumed_runs: 0
- output_run_dir: /workspace/casimirbot-/artifacts/experiments/helix-signal-reliability/narrow/versatility-1771699737631
...
|---|---:|---:|---:|---:|---:|---:|---:|
| relation | 45 | 100.0% | 100.0% | 100.0% | 0.0% | 392 | 1141 |
| repo_technical | 45 | 100.0% | 0.0% | 100.0% | 0.0% | 621 | 1496 |
| ambiguous_general | 45 | 100.0% | 0.0% | 100.0% | 0.0% | 702 | 1400 |
...
- latency_total_p50_ms: 623
- latency_total_p95_ms: 1413
- latency_retrieval_p50_ms: 183 (samples=128)
- latency_retrieval_p95_ms: 330 (samples=128)
- latency_synthesis_p50_ms: 1 (samples=135)
- latency_synthesis_p95_ms: 39 (samples=135)
...
### Worst #4: repo_tech_08_what-does-api-agi-adapter-run-return-for-pass-fail-and-certificate-data
- family: repo_technical
...
### Worst #7: ambiguous_12_what-s-a-clean-way-to-structure-a-short-answer
- family: ambiguous_general
...
### Worst #8: ambiguous_11_how-do-i-ask-better-technical-questions
- family: ambiguous_general
...
### Worst #11: ambiguous_08_what-s-a-good-way-to-summarize-evidence
- family: ambiguous_general
