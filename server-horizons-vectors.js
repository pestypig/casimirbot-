...
server.listen(PORT, () => {
  console.log(`🚀 Horizons BCRS server running on http://localhost:${PORT}`);
  console.log(`📊 HaloBank: http://localhost:${PORT}/halobank.html`);
  console.log(`🧪 Vectors API: http://localhost:${PORT}/api/horizons/vectors?ts=2025-09-24T12:34:56Z`);
});