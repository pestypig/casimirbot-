...
| Provider-neutral external-agent connection and Helix activity surface | specified | `docs/work-packets/eh-g8-provider-neutral-agent-connection-and-helix-activity-v1.md`; `docs/work-packets/eh-g8-pna1-packaging-ux-readiness-boundary-v1.md`; `docs/evidence/eh-g8-pna1-packaging-ux-readiness-boundary-v1/2026-08-31-deterministic-acceptance.json`; `docs/work-packets/eh-g8-pna2-provider-neutral-agent-connections-v1.md`; `docs/evidence/eh-g8-pna2-provider-neutral-agent-connections-v1/2026-08-31-independent-client-live-checkpoint.json`; `docs/evidence/eh-g8-pna2-provider-neutral-agent-connections-v1/2026-08-31-installed-codex-refresh-continuity-checkpoint.json`; `docs/evidence/eh-g8-pna2-provider-neutral-agent-connections-v1/2026-08-31-agent-connections-disconnect-reactivation-acceptance.json`; `docs/evidence/eh-g8-pna2-provider-neutral-agent-connections-v1/2026-08-31-stage2-completion-audit.json`; `docs/architecture/casimirbot-environment-harness-product-goal-v1.md`; `docs/architecture/helix-agent-api-v1.md` | PNA1 and the bounded PNA2 contract/status/guided-setup slices are deterministically verified. PNA2 has live independent standards-client authenticated discovery, one safe full-harness catalog call, live installed Codex authorization/presence/restart continuity, fresh unpacked current-source desktop acceptance of the explicit profile-binding disconnect/reconnect journey, a 122/122 focused completion battery, a passing release-slice audit that now contains the Stage 2 source and evidence boundaries, and a pre-signing desktop workflow gate backed by Casimir adapter run `2605` (PASS, certificate integrity OK). The reconnect test exposed and repaired a missing explicit store reactivation handoff after fresh native PKCE consent; the final current-source build projected an active binding plus current catalog and chat attachment without expanding Helix authority. PNA2 remains active because public protected-resource metadata routing still returns the website SPA instead of JSON and a signed installed current desktop release has not yet repeated the current-source journey. No hidden endpoint bypass or integrated-acceptance claim is made. Later stages add exact composer destination and delivery state, progressive durable activity, keyboard/assistive/compact support, context privacy, automatic ordinary MCP lifecycle projection, optional epoch-bound mission correlation, public companion/Dottie events without hidden-reasoning claims, principal-only voice continuation or truthful pickup state, optional provider-backed Helix chat, and cross-client installed-node acceptance. Codex App is the first supported profile, not the portable runtime contract. |
