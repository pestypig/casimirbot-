...
| EXP-SE-012 | SRC-050 | Ellipsometry reference-procedure validated thickness range | 10 to 1000 | nm | UNKNOWN | Single-layer SiO2 and Si3N4 films measured by spectroscopic ellipsometry and XRR | BAM Reference Procedure 53 summary page | metadata | standard | `d_ellip_nm` | extracted |
| EXP-SE-013 | SRC-050 | Ellipsometry expanded uncertainty target | +/-1.0 | nm | k=2 | Same conditions as EXP-SE-012 | BAM Reference Procedure 53 summary page | metadata | standard | `u_ellip_nm`,`U_fused_nm` | extracted |
