...
W=json.loads(source.read_text())['carbon_forward_W_GeV_minus2']
...
out=dict(status='nuclear_only_smooth_sphere_component_not_total_diamond_prediction',
 ...
 assumptions=['uniform rigid sphere of identical nuclear contact amplitudes',
 'same xenon-normalized coefficient, speed, density and frozen hold',
 'no electrons, lattice excitations, correlations or detector fit'])
