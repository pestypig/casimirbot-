...
The correct interpretation is not "transport validated." The row is a diagnostic campaign-admissible profile under the current local generated artifact chain. Physical viability, route ETA, propulsion, transport, certified speed, material realization, and external validation remain outside the claim.
...
| 0p7000 observer-compatible source campaign | `campaignPass = true`; `profileCampaignFrontierComplete = true`; `firstBlocker = null` | diagnostic campaign-admissible only; not physical viability, route ETA, propulsion, transport, or certified speed |
...
| `formal/lean/NHM2Formal.ClaimBoundary` | Lean claim-boundary formalization lane | machine-checks that diagnostic campaign pass, clocking replay, scalar closure, observer scope, and source authority do not imply physical / route / transport claims | formal policy proof only; does not validate numerical GR, material source physics, route ETA, propulsion, or certified speed |
