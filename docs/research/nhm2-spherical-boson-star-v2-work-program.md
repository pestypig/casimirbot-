...
Active program gate: **G2D — fresh replacement-candidate proof attempt**
...
[`nhm2-spherical-boson-star-v2-g2d-fluid-star-proof-attempt.md`](./nhm2-spherical-boson-star-v2-g2d-fluid-star-proof-attempt.md).
...
| Candidate definition         | The closed G2B candidate identity and N=64/96/128/256 policy remain immutable evidence. G2C selected one replacement family, but no exact G2D candidate or parameter is frozen; admitted candidates: 0. |
...
| Classical branch diagnostics | M3/M5 has an independently admitted core-duty PASS, but the frozen branch is closed without a terminal candidate. B4-R10 failed at N=64 stage 0 after 29 updates. B4-R11-R1 reproduces correction 29 and all 25 `w>=1` domain rejections and finds no unique supported successor. G2C selected the fluid-star control family; G2D preregistration is active and admitted candidates remain 0. |
...
| Numerical decision           | The historical frozen-core `GO` remains immutable evidence, but the later integrated G2B branch failed before completing N=64 stage 0 and is closed. No replacement execution is eligible until G2D preregistration and separate one-shot authority. |
...
| G2D — Fresh replacement-candidate proof attempt      | active: preregistration only | Freeze one exact low-compactness fluid-star member, analytic identities, interface duties, interval replays, thresholds, chronology, disjoint runtimes, exclusive root and falsifiers before any evaluation. | G3 |
| G3 — Accepted joint geometry and quantum state       | blocked by G2D                         | A converged joint fixed-point witness binding the same geometry, Hadamard state, renormalization/effective-action definitions, spectral evidence, and authenticated bytes                                                                                                                                                                                                               | G4                            |
...
Exactly one gate is active. Until G2D closes, work must contribute directly
to replacement-candidate preregistration and authenticated classical proof or be explicitly
