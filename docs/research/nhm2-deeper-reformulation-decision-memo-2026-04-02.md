# NHM2 Deeper Reformulation Decision Memo (2026-04-02)
...
- nhm2_reform_volume_driven_signed_source: movement=toward_flat_or_degenerate; magnitude=0.05119133496811057; sourceReformulationMode=volume_driven_signed_source; implication=This model-form change is too destructive in its current form and removes morphology amplitude faster than it creates signed-lobe structure.
- nhm2_reform_fore_aft_antisymmetric_driver: movement=toward_flat_or_degenerate; magnitude=0.05323271131471796; sourceReformulationMode=fore_aft_antisymmetric_driver; implication=This model-form change is too destructive in its current form and removes morphology amplitude faster than it creates signed-lobe structure.
- nhm2_reform_geometry_source_decoupling: movement=toward_flat_or_degenerate; magnitude=0.05272280519154737; sourceReformulationMode=geometry_source_decoupling; implication=This model-form change is too destructive in its current form and removes morphology amplitude faster than it creates signed-lobe structure.
- nhm2_reform_shell_to_dual_layer_family: movement=toward_flat_or_degenerate; magnitude=0.05269490207806571; sourceReformulationMode=shell_to_dual_layer_family; implication=This model-form change is too destructive in its current form and removes morphology amplitude faster than it creates signed-lobe structure.
