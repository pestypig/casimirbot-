...
| `com.casimirbot.minecraft.spatial_region.inspect`       | [environment-connector.probe.md](environment-connector.probe.md)                                         | `draft`     |
...
| `com.casimirbot.minecraft.registry.fact.read`           | [environment-connector.probe.md](environment-connector.probe.md)                                         | `draft`     |
| `com.casimirbot.minecraft.recipe.fact.read`             | [environment-connector.probe.md](environment-connector.probe.md)                                         | `draft`     |
...
| `com.casimirbot.minecraft.player.navigate`              | [environment-connector.player-action.md](environment-connector.player-action.md)                         | `draft`     |
| `com.casimirbot.minecraft.player.look`                  | [environment-connector.player-action.md](environment-connector.player-action.md)                         | `draft`     |
| `com.casimirbot.minecraft.player.camera.track`          | [environment-connector.player-action.md](environment-connector.player-action.md)                         | `draft`     |
| `com.casimirbot.minecraft.player.walk`                  | [environment-connector.player-action.md](environment-connector.player-action.md)                         | `draft`     |
| `com.casimirbot.minecraft.player.jump`                  | [environment-connector.player-action.md](environment-connector.player-action.md)                         | `draft`     |
| `com.casimirbot.minecraft.player.interact`              | [environment-connector.player-action.md](environment-connector.player-action.md)                         | `draft`     |
| `com.casimirbot.minecraft.player.hotbar.select`         | [environment-connector.player-action.md](environment-connector.player-action.md)                         | `draft`     |
| `com.casimirbot.minecraft.player.equipment.equip`       | [environment-connector.player-action.md](environment-connector.player-action.md)                         | `draft`     |
| `com.casimirbot.minecraft.player.follow`                | [environment-connector.player-action.md](environment-connector.player-action.md)                         | `draft`     |
| `com.casimirbot.minecraft.player.collect`               | [environment-connector.player-action.md](environment-connector.player-action.md)                         | `draft`     |
| `com.casimirbot.minecraft.player.mine`                  | [environment-connector.player-action.md](environment-connector.player-action.md)                         | `draft`     |
| `com.casimirbot.minecraft.player.place`                 | [environment-connector.player-action.md](environment-connector.player-action.md)                         | `draft`     |
| `com.casimirbot.minecraft.player.craft`                 | [environment-connector.player-action.md](environment-connector.player-action.md)                         | `draft`     |
...
| `com.casimirbot.minecraft.player.emergency_stop`        | [environment-connector.player-action.md](environment-connector.player-action.md)                         | `draft`     |
| `com.casimirbot.minecraft.situation_digest.read`        | [environment-connector.situation-digest.md](environment-connector.situation-digest.md)                   | `draft`     |
| `environment.minecraft.fabric_loopback.launch_and_join` | [environment-connector.local-lifecycle.md](environment-connector.local-lifecycle.md)                     | `draft`     |
