...
| `com.casimirbot.minecraft.player.place` | `block_id`, `positions`; optional `environment_label` | `helix.environment_action.observation.v1` | Places held blocks at exact admitted positions with support-face checks and verifies every resulting block state. |
...
| `com.casimirbot.minecraft.player.place`                 | `block_id`, `positions`                                                                                                                                                                                                                                                    |
