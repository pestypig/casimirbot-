...
The extraction wave now continues through S246. Recent slices moved small,
...
| S245/S246 | live-source mail observation readers | `server/services/helix-ask/live-source/mail-observation-readers.ts` | SERVICE_OWNED for already-materialized live-source observation and processed mail packet reading only |
