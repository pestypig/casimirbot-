...
| `live_source_mail_answer_drafts` | `live-source/mail-answer-drafts.ts` | service via route import | no inline implementation | already-materialized mail item summaries and watch-policy records | yes, draft strings and salience candidates feed route-owned live-source mail terminal and voice-callout paths | yes for deterministic mail summary compaction, text-answer drafting, watch-policy text-for-every-batch detection, and provisional voice-callout salience candidates only | live-source mail answer drafts boundary test | SERVICE_OWNED |
...
The extraction wave now continues through S255. Recent slices moved small,
...
| S255 | live-source mail answer drafts | `server/services/helix-ask/live-source/mail-answer-drafts.ts` | SERVICE_OWNED for deterministic mail summary compaction, text-answer drafting, watch-policy text-for-every-batch detection, and provisional voice-callout salience candidates only |
