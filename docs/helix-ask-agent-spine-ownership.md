...
| `doc_args` | `doc-args.ts` | service and service factory via route import | no inline implementation | supplied transcript text plus route-owned structured-docs prompt guard | yes, explicit doc-path args, latest-doc reader results, and open-doc query reader results can feed doc context/planning | yes for doc prompt argument, latest-doc prompt interpretation, docs-panel-open detection, and open-doc query reading only | doc-args boundary test | SERVICE_OWNED |
...
- Explicit doc-path argument extraction is service-owned after S152,
  ...
  open-doc query reader helpers are service-owned after S176;
