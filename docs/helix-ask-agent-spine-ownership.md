...
- Turn-contract objective fragment splitting, slot/query-hint inference,
  ...
  planner-section normalization, and goal text selection are service-owned
  after S130 and S198-S202;
