...
- Fallback-section grounding adaptation is service-owned after S221; route still
  selects fallback profile tables and preserves wrapper call order for obligation
