...
| S199 | turn-contract risk flags | `server/services/helix-ask/contracts/turn-contract-risk-flags.ts` | SERVICE_OWNED for deterministic risk-flag aggregation from already-selected inputs only |
| S200 | turn-contract clarify question | `server/services/helix-ask/contracts/turn-contract-clarify-question.ts` | SERVICE_OWNED for deterministic clarify-question assembly from already-selected inputs only |
...
| S204 | turn-contract objectives | `server/services/helix-ask/contracts/turn-contract-objectives.ts` | SERVICE_OWNED for deterministic objective normalization and fallback construction only |
...
- Turn-contract objective fragment splitting, slot/query-hint inference,
  ...
  projection, risk-flag aggregation, clarify-question assembly, and
  planner-section source selection/normalization, goal text selection,
  objective normalization/fallback construction, query-hint assembly, and
  answer-format packaging are service-owned after S130 and S198-S207;
