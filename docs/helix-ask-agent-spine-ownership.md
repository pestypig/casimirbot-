...
- Turn-contract objective fragment splitting, slot/query-hint inference,
  ...
  planner-section source selection/normalization, goal text selection, and
  objective normalization/fallback construction are service-owned after S130
  and S198-S204;
...
- Query merging is service-owned after S205; route-owned retrieval policy,
  query source selection, and retrieval execution remain unresolved.
