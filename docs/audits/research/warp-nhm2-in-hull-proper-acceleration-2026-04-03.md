# NHM2 In-Hull Proper Acceleration (2026-04-03)
...
| brickDims | 24,24,24 |
| voxelSize_m | 41.958333333333336,11,7.208333333333333 |
...
| note | Direct gr-evolve brick sampling shows a zero proper-acceleration profile across the bounded cabin-cross family, and the current NHM2 metric path has no declared lapse-profile companion. This is treated as a certified constant-lapse zero-profile result rather than as an under-resolved fallback case. |
