# Nanogap Compatibility Check (2026-03-06T05:41:27.208Z)

This campaign defines falsifiable reduced-order full-solve gates and reproducible evidence requirements; it is not a physical warp feasibility claim.

## Inputs
- scenario_pack: `configs/warp-shadow-injection-scenarios.ng-primary-typed.v1.json`
- run_artifact: `artifacts/research/full-solve/shadow-injection-run-ng-primary-typed-2026-03-06-repeat.json`
