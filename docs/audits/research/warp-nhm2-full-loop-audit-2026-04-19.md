# NHM2 Full-Loop Audit (2026-04-19)
...
| generatedAt | 2026-04-19T23:10:42.495Z |
...
| observerTileAuthorityNote | Tile-effective observer authority remains proxy-limited (routeAdmission=pass; fullTensorComponents=pass; comparability=fail). |
| observerLeadReadinessWorkstream | observer_completeness_and_authority |
| observerLeadReadinessReason | Observer fail remains mixed: same-surface negativity is real and tile-effective authority remains proxy-limited. Certificate/policy readiness remains a separate parallel full-loop lane. |
...
| tile.wecMinOverAllTimelike | -43392729088 |
