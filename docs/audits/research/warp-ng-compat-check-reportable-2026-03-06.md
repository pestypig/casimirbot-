# Nanogap Compatibility Check (2026-03-06T05:41:38.325Z)

This campaign defines falsifiable reduced-order full-solve gates and reproducible evidence requirements; it is not a physical warp feasibility claim.

## Inputs
- scenario_pack: `configs/warp-shadow-injection-scenarios.ng-primary-reportable.v1.json`
- run_artifact: `artifacts/research/full-solve/shadow-injection-run-ng-primary-reportable-2026-03-06.json`
