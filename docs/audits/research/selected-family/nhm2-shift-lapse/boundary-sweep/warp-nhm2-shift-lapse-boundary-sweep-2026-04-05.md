# NHM2 Shift+Lapse Stronger-Side Boundary Sweep (2026-04-05)
...
- testedStrongerBracketStopProfileId: `stage1_centerline_alpha_0p8800_v1`
- testedStrongerBracketStopCenterlineAlpha: `0.88`
- canonicalBaselineMetricT00Ref: `warp.metric.T00.natario_sdf.shift`
- canonicalBaselineLatestAliasesChanged: false

## Boundary Result
- strongestProfileKeepingAllGatesPassing: `stage1_centerline_alpha_0p8800_v1`
...
- marginFromReferenceProfile: No first-failure boundary was reached within the tested stronger bracket. Relative to stage1_centerline_alpha_0p995_v1, the tested stronger-side passing margin extends through stage1_centerline_alpha_0p8800_v1.
- marginFromStrongestPassingProfile: No first-failure boundary was reached beyond stage1_centerline_alpha_0p8800_v1 within the tested stronger bracket.
- boundarySummary: No first-failure boundary was reached within the tested stronger bracket. Through stage1_centerline_alpha_0p8800_v1, every tested stronger-side profile remained gate-admitted, and the bounded timing differential scales monotonic within the passing region. The current predefined exploration stop is stage1_centerline_alpha_0p8800_v1.
...
- wallSafetyBetaUsage (max(betaOverAlphaMax, betaOutwardOverAlphaWallMax)): `2.510767082283403e-17`
- wallSafetyBetaMargin: `1`
- wallSafetyHorizonMargin: `1`
- wallSafetyWorstUsage: `2.510767082283403e-17`
