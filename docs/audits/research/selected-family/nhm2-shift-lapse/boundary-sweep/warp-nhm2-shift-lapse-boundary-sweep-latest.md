...
- marginFromReferenceProfile: No first-failure boundary was reached within the tested stronger bracket. Relative to stage1_centerline_alpha_0p995_v1, the tested stronger-side passing margin extends through stage1_centerline_alpha_0p7700_v1.
- marginFromStrongestPassingProfile: No first-failure boundary was reached beyond stage1_centerline_alpha_0p7700_v1 within the tested stronger bracket.
- boundarySummary: No first-failure boundary was reached within the tested stronger bracket. Through stage1_centerline_alpha_0p7700_v1, every tested stronger-side profile remained gate-admitted, and the bounded timing differential scales monotonic within the passing region. The current predefined exploration stop is stage1_centerline_alpha_0p7700_v1.
...
- wallSafetyBetaUsage (max(betaOverAlphaMax, betaOutwardOverAlphaWallMax)): `2.869448149568188e-17`
- wallSafetyBetaMargin: `1`
- wallSafetyHorizonMargin: `1`
- wallSafetyWorstUsage: `2.869448149568188e-17`
