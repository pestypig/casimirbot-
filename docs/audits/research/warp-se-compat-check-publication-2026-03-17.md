# SEM+Ellipsometry Compatibility Check (2026-03-17T16:57:34.346Z)

This campaign defines falsifiable reduced-order full-solve gates and reproducible evidence requirements; it is not a physical warp feasibility claim.

## Inputs
- scenario_pack: `configs\warp-shadow-injection-scenarios.se-publication-typed.v1.json`
- run_artifact: `artifacts\research\full-solve\shadow-injection-run-se-publication-typed-2026-03-17.json`
