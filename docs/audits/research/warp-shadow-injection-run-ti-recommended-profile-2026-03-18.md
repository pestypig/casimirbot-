...
|---|---|---|---|---|---:|---:|---|
| ti_primary_typed_wr_short_ps_sigma_50ps | timing | WR-SHORT-PS;sigma=50;ts=hardware | compatible | true | 0.1928877525715478 | -0.8071122474284522 | none |
| ti_primary_typed_wr_longhaul_exp_sigma_6ps | timing | WR-LONGHAUL-EXP;sigma=6;ts=hardware | compatible | true | 0.1928877525715478 | -0.8071122474284522 | none |
