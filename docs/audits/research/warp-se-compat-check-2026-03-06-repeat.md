# SEM+Ellipsometry Compatibility Check (2026-03-06T18:26:15.479Z)

This campaign defines falsifiable reduced-order full-solve gates and reproducible evidence requirements; it is not a physical warp feasibility claim.

## Inputs
- scenario_pack: `configs/warp-shadow-injection-scenarios.se-primary-typed.v1.json`
- run_artifact: `artifacts/research/full-solve/shadow-injection-run-se-primary-typed-2026-03-06-repeat.json`
