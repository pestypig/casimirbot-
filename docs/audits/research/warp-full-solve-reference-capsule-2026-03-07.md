# Full-Solve Reference Capsule (2026-03-07)
...
- checksum: `c7072238d69cb50c1b0a849d40b2597c3880a3f5d26f5f2be17926b4150dde7e`
- blocked: `false`

## Canonical State
- decision: `REDUCED_ORDER_ADMISSIBLE`
- counts: `PASS=8, FAIL=0, UNKNOWN=0, NOT_READY=0, NOT_APPLICABLE=1`
- strong_claim_pass_all: `false`

## Certification
- trace_id: `adapter:2d69e887-b3a7-4663-b95b-ff514f72bff6`
- run_id: `27635`
...
| nanogap | 5 / 5 / 0 | 5 / 5 / 0 |
| timing | 9 / 2 / 1 | 9 / 2 / 1 |
| sem_ellipsometry | 8 / 0 / 10 | 0 / 0 / 18 |
| qcd_analog | 0 / 0 / 0 | 0 / 0 / 0 |

## External Work Comparison
- matrix_path: `artifacts/research/full-solve/external-work/external-work-comparison-matrix-2026-03-07.json`
- total: `14`
- compatible: `7`
- partial: `5`
- inconclusive: `2`
...
|---|---|---|---|
| strong_claim_closure_not_pass_all | SOFT | artifacts\research\full-solve\warp-evidence-snapshot-2026-03-02.json | strongClaimClosure.passAll=false |
