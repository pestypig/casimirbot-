# Q-Spoiling Compatibility Check (2026-03-18)

This campaign defines falsifiable reduced-order full-solve gates and reproducible evidence requirements; it is not a physical warp feasibility claim.

## Inputs
- scenario_pack: `configs\warp-shadow-injection-scenarios.qs-primary-reportable.v1.json`
- run_artifact: `artifacts\research\full-solve\shadow-injection-run-qs-primary-reportable-readiness-2026-03-18.json`
