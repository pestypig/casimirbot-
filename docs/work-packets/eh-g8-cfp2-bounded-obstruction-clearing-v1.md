...
Allowed files: shared/helix-minecraft-player-capabilities.ts; selected action-broker/admission files; minecraft/helix-fabric-player-agent NativeFabricWorkflowEngine and mining geometry/affordance tests; applicable connector-core bounds and exact adapter documentation after reading its instructions. Coordinate schema/MCP ownership with PUBLIC.
