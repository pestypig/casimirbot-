...
Deep mixing is the slow, controlled circulation plan used to extend the Sun's main-sequence lifetime by moving envelope hydrogen toward the core through the tachocline. In this repo, the plan is captured in the Deep Mixing autopilot preset and the tachocline setpoint helpers.
