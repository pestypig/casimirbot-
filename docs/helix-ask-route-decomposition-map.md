...
Pinned source HEAD described: `eafbd36b99c96b7b22aaf221d0bc4e442ebd8d68`
...
| Lines | 180,755 |
| Bytes | 8,102,999 |
| Top-level helper estimate | 346 helper blocks |
...
| `turn-contract-objective-mini-answers` | objective loop / evidence re-entry | service-owned | Assemble objective mini-answer records from loop states, support, coverage, retrieval files, fallback evidence refs, summarize status counts, render objective mini-synth/mini-critic prompts, and apply parsed mini-synth results. | Extracted by S112-S113 and S116-S118 with covered/blocked/fallback, summary-count, prompt-rendering, and mini-synth application behavior coverage. LLM invocation, mini-synth/critic parsing, repair, and critique application remain route-owned. | `EXTRACTED` |
