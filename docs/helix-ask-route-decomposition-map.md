...
Pinned source HEAD described: `d571d913f5d9a2ca1b9fb47aa4204731af8c8e80`
...
| Lines | 180,196 |
| Bytes | 8,082,611 |
| Top-level helper estimate | 329 helper blocks |
...
| `objective-loop-debug` | objective loop / evidence re-entry | service-owned | Evaluate objective terminal status, coverage, unknown-block enforcement, and objective evidence sufficiency diagnostics. | S122 routed pure objective-loop status/coverage/unknown/OES helpers through `server/services/helix-ask/objectives/objective-loop-debug.ts`. Runtime transition sequencing, retrieval recovery, and LLM objective stages remain route-owned or owned by recovery/runtime shells. | `PARTIAL_EXTRACTED` |
