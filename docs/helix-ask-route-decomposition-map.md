...
Pinned source HEAD described: `c85f4f435f6a633390af770246c957f0500c1c87`
...
| Lines | 180,827 |
| Bytes | 8,105,460 |
| Top-level helper estimate | 347 helper blocks |
...
| `turn-contract-objective-mini-answers` | objective loop / evidence re-entry | service-owned | Assemble objective mini-answer records from loop states, support, coverage, retrieval files, fallback evidence refs, summarize status counts, and render objective mini-synth/mini-critic prompts. | Extracted by S112-S113 and S116-S117 with covered/blocked/fallback, summary-count, and prompt-rendering behavior coverage. LLM invocation, mini-synth/critic parsing, repair, and critique application remain route-owned. | `EXTRACTED` |
