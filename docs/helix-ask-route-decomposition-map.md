...
Pinned source HEAD described: `2c82d916a4f17a5b81713be50756378a989aeba8`
...
| Lines | 179,779 |
| Bytes | 8,066,659 |
| Top-level helper estimate | 321 helper blocks |
...
| `objective-llm-contracts` | objective loop / evidence re-entry | partially service-owned | Render deterministic objective retrieve-proposal prompts and parse retrieve-proposal JSON packets. | S125 routed retrieve-proposal prompt rendering and parser helpers through `server/services/helix-ask/objectives/objective-llm-contracts.ts`. Route still owns mini-synth and mini-critic parser duplicates until their type/unknown-block equivalence is characterized. | `PARTIAL_EXTRACTED` |
