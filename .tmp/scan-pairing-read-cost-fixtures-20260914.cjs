...
fs.writeFileSync('docs/evidence/eh-g8-et6-continuous-session-build-v1/2026-09-14-pairing-read-cost-fixture-scan.json',JSON.stringify(result,null,2)+'\n',{flag:'wx'});
