...
const root = path.resolve('apps/desktop/release-durable-action-20260913/win-unpacked');
...
fs.writeFileSync('docs/evidence/eh-g8-et6-continuous-session-build-v1/2026-09-13-durable-action-fixture-scan.json',JSON.stringify(result,null,2)+'\n',{flag:'wx'});
