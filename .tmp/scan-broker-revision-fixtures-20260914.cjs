...
const root = path.resolve('apps/desktop/release-broker-revision-20260914/win-unpacked');
...
fs.writeFileSync('docs/evidence/eh-g8-et6-continuous-session-build-v1/2026-09-14-broker-revision-fixture-scan.json',JSON.stringify(result,null,2)+'\n',{flag:'wx'});
