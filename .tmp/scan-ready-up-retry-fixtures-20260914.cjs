...
const root = path.resolve('apps/desktop/release-ready-up-retry-20260914/win-unpacked');
...
fs.writeFileSync('docs/evidence/eh-g8-et6-continuous-session-build-v1/2026-09-14-ready-up-retry-fixture-scan.json',JSON.stringify(result,null,2)+'\n',{flag:'wx'});
