...
// .tmp/cs3-root-plan-builder-readcost-20260914.ts
var cs3_root_plan_builder_readcost_20260914_exports = {};
__export(cs3_root_plan_builder_readcost_20260914_exports, {
  buildRoot: () => buildRoot
});
module.exports = __toCommonJS(cs3_root_plan_builder_readcost_20260914_exports);
...
function buildRoot(frontier, planning, actor) {
  ...
  const plan = buildHelixEnvironmentTemporalPlan({
    ...
    plan_id: "plan:cs3-root-motion-baseline-20260914-02",
    previous_plan_id: null,
    previous_plan_hash: null,
    identity: frontier.identity,
    clocks: { environment: { kind: "tick", sequence: resident.clock.tick_index, resolution_unit: "minecraft_tick", nominal_units_per_second: 20 }, monotonic, audit_at: (/* @__PURE__ */ new Date()).toISOString() },
    ...
    monotonic_deadline_elapsed_ms: monotonic.elapsed_ms + 7500,
    ...
    effect_ceiling: {},
    nodes: [
      { kind: "checkpoint", node_id: "initial", checkpoint_id: "checkpoint:cs3-root-initial-20260914-02", required_evidence_kinds: ["player_pose"], condition: condition2("position_within", { position: actor.position, radius: 0.75 }), wait_up_to_units: 1, on_satisfied_node_id: "walk", on_timeout_node_id: "failed" },
      ...
      { kind: "checkpoint", node_id: "arrival", checkpoint_id: "checkpoint:cs3-root-arrival-20260914-02", required_evidence_kinds: ["player_pose"], condition: condition2("position_within", { position: destination, radius: 1.5 }), wait_up_to_units: 1, on_satisfied_node_id: "success", on_timeout_node_id: "failed" },
