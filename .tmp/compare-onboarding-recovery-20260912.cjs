...
const root = path.resolve('apps/desktop/release-onboarding-recovery-20260912/win-unpacked');
...
fs.writeFileSync('docs/evidence/eh-g8-et6-continuous-session-build-v1/2026-09-12-onboarding-recovery-package.json',JSON.stringify(result,null,2)+'\n',{flag:'wx'});
