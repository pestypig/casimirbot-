...
const root = path.resolve('apps/desktop/release-binding-check-diagnostic-20260914/win-unpacked');
...
fs.writeFileSync('docs/evidence/eh-g8-et6-continuous-session-build-v1/2026-09-14-binding-check-diagnostic-fixture-scan.json',JSON.stringify(result,null,2)+'\n',{flag:'wx'});
