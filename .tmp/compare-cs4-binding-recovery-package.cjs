...
const root=path.resolve('apps/desktop/release-cs4-binding-recovery-20260908/win-unpacked');
...
const result={scope:'Built package identity and content comparison; native recovery pending',output:root,
 build_exit_code:0,runtime_files_compared:Object.keys(staged).length,runtime_mismatches:mismatches,runtime_extras:extras,bundles,
...
fs.writeFileSync('docs/evidence/eh-g8-et6-continuous-session-build-v1/2026-09-08-cs4-binding-recovery-package.json',JSON.stringify(result,null,2)+'\n');
