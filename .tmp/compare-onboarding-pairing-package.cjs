...
const root=path.resolve('apps/desktop/release-onboarding-pairing-20260908/win-unpacked');
...
fs.writeFileSync('docs/evidence/eh-g8-et6-continuous-session-build-v1/2026-09-08-onboarding-pairing-package.json',JSON.stringify(result,null,2)+'\n');
