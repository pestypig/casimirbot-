...
const root = path.resolve('apps/desktop/release-onboarding-delivery-20260912/win-unpacked');
const markers = ['fixture-browser-session','fixture_human_route_required','fixture_provider_denied','ephemeralPairingVault','onboarding-real-handlers-','STEERING_PROCESS_FIXTURE_KEY','FIXTURE_RESULT:','steering_process_fixture_failed','fixture-auto-message','fixture-lost-provider-reply'];
...
fs.writeFileSync('docs/evidence/eh-g8-et6-continuous-session-build-v1/2026-09-12-delivery-package-fixture-scan.json',JSON.stringify(result,null,2)+'\n',{flag:'wx'});
