...
const root = path.resolve('apps/desktop/release-oauth-dispatch-20260913/win-unpacked');
...
fs.writeFileSync('docs/evidence/eh-g8-et6-continuous-session-build-v1/2026-09-13-oauth-dispatch-package.json',JSON.stringify(result,null,2)+'\n',{flag:'wx'});
