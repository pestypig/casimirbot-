...
function inspect(name, bytes) {
  ...
  if (!/\.(?:[cm]?js|json|html|css|ts|tsx|md|txt)$/.test(name)) return;
...
fs.writeFileSync('docs/evidence/eh-g8-et6-continuous-session-build-v1/2026-09-13-pending-bootstrap-fixture-scan.json',JSON.stringify(result,null,2)+'\n',{flag:'wx'});
