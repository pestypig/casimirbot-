...
const root=path.resolve('apps/desktop/release-cs4-profile-recovery-20260908/win-unpacked');
...
fs.writeFileSync('docs/evidence/eh-g8-et6-continuous-session-build-v1/2026-09-08-cs4-profile-recovery-package.json',JSON.stringify(result,null,2)+'\n');
