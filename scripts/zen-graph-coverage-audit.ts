import { auditZenGraphCoverage } from "../shared/zen-graph/audit-zen-graph-coverage";
...
function printMarkdown(report: ReturnType<typeof auditZenGraphCoverage>): void {
  console.log(`# ZenGraph Coverage Audit`);
  console.log("");
...
async function main(): Promise<void> {
  ...
  const report = auditZenGraphCoverage(graph);
