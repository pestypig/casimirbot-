#!/usr/bin/env python3
"""Static audit of the candidate-neutral P8P-R18 consent preflight."""
...
R17 = ROOT / "docs/research/nhm2-spherical-boson-star-v2-g2h-e-s5-a4-h2-p8p-r17-standalone-cloudshell-result.md"
...
checks = {
    ...
    "r17_identity": digest(R17) == "2503c7c376faf0a42d2c7e14bafd28f684419004130fedb4d04f44aaa1e698b3",
    "retained_tab": "reuse only that retained tab" in flat and "open or reload a tab" in flat,
    ...
    "consent_scope": "not permission to mutate IAM" in flat,
    "one_command": text.count("R18_CONNECTION_READY") == 2 and "exactly one read-only command" in flat,
    ...
    "first_failure": "First failure is terminal and consumes R18" in flat,
